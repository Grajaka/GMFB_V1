...
export default function NavBar() {
    return (
        <nav className="flex justify-between w-full h-[10%] drop-shadow-md shadow-[4px] bg-[var(--color-blueFB)]">
            <ul className="flex items-center gap-6 text-white drop-shadow-md shadow-[4px] p-1 m-1.5;">
                <Link to={"/"}>
            ...
            <ul className="flex justify-end p-1 gap-6 bg-blueFB hover:border-orangeFB text-white">
                <Link to={"/VisualGnrl"}>
